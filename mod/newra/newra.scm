...
(define (pick-typed-vector-functions v)
  (cond ((vector? v)    (values  #t    vector-length     (lambda (v i) (vector-ref v i))     (lambda (v i o) (vector-set! v i o))))
        ((c64vector? v) (values  'c64  c64vector-length  (lambda (v i) (c64vector-ref v i))  (lambda (v i o) (c64vector-set! v i o))))
        ((c32vector? v) (values  'c32  c32vector-length  (lambda (v i) (c32vector-ref v i))  (lambda (v i o) (c32vector-set! v i o))))
        ((f64vector? v) (values  'f64  f64vector-length  (lambda (v i) (f64vector-ref v i))  (lambda (v i o) (f64vector-set! v i o))))
        ((f32vector? v) (values  'f32  f32vector-length  (lambda (v i) (f32vector-ref v i))  (lambda (v i o) (f32vector-set! v i o))))
        ((s64vector? v) (values  's64  s64vector-length  (lambda (v i) (s64vector-ref v i))  (lambda (v i o) (s64vector-set! v i o))))
        ((s32vector? v) (values  's32  s32vector-length  (lambda (v i) (s32vector-ref v i))  (lambda (v i o) (s32vector-set! v i o))))
        ((s16vector? v) (values  's16  s16vector-length  (lambda (v i) (s16vector-ref v i))  (lambda (v i o) (s16vector-set! v i o))))
        ((s8vector? v)  (values  's8   s8vector-length   (lambda (v i) (s8vector-ref v i))   (lambda (v i o) (s8vector-set! v i o))))
        ((u64vector? v) (values  'u64  s64vector-length  (lambda (v i) (s64vector-ref v i))  (lambda (v i o) (s64vector-set! v i o))))
        ((u32vector? v) (values  'u32  s32vector-length  (lambda (v i) (s32vector-ref v i))  (lambda (v i o) (s32vector-set! v i o))))
        ((u16vector? v) (values  'u16  s16vector-length  (lambda (v i) (s16vector-ref v i))  (lambda (v i o) (s16vector-set! v i o))))
        ((u8vector? v)  (values  'u8   s8vector-length   (lambda (v i) (s8vector-ref v i))   (lambda (v i o) (s8vector-set! v i o))))
        ((string? v)    (values  'a    string-length     (lambda (v i) (string-ref v i))     (lambda (v i o) (string-set! v i o))))
        ((bitvector? v) (values  'b    bitvector-length  (lambda (v i) (bitvector-ref v i))  (lambda (v i o) (bitvector-set! v i o))))
; @TODO extend this idea to 'non-strict arrays' (cf Racket), to a method for drag-along
        ((dim? v)       (values  'd    dim-len           (lambda (v i) (dim-ref v i))        (cut throw 'no-dim-set! <...>)))
